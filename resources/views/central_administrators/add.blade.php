...
<li class="breadcrumb-item active" aria-current="page">
    <a href="{{ route('central_administrators.list') }}">Централни администратори</a>
</li>
<li class="breadcrumb-item active" aria-current="page">
    Добавяне
</li>
...
@section('content')
    <div class="container-fluid">
        <div class="row g-4">
            <div class="col-md-12">
                <form method="POST" action="{{ route('central_administrators.store') }}">
                    @csrf
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="card-title">Добави централен администратор</div>
                        </div>
                        <div class="card-body">
                            <div class="row g-4">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('central_administrators.list') }}" class="btn btn-secondary me-3">Върни се</a>
