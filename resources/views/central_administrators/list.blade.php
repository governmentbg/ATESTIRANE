...
@section('title') Централни администратори @endsection
...
@section('content')
    <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('central_administrators.add') }}" class="btn btn-primary">Добави нов</a>
                        </div>
                    </div>
                    <form method="GET">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('central_administrators.list') }}" class="btn btn-secondary me-3">Изчисти филтри</a>
        ...
        <div class="row g-4">
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <div class="card-title">Списък с централни администратори</div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('central_administrators.delete', ['id' => $user->id]) }}" class="btn btn-danger delete" data-bs-toggle="modal" data-bs-target="#deleteAdministratorModal"><i class="nav-icon bi bi-trash3"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @else
    ...
    @include('central_administrators.delete-dialog')
@endsection
