                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('competence_score.list', ['type' => 'management']) }}" class="btn btn-primary">Избери</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td>
                                        <a href="{{ route('competence_score.list', ['type' => 'experts']) }}" class="btn btn-primary">Избери</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    ...
                                    <td>
                                        <a href="{{ route('competence_score.list', ['type' => 'general']) }}" class="btn btn-primary">Избери</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    ...
                                    <td>
                                        <a href="{{ route('competence_score.list', ['type' => 'technical']) }}" class="btn btn-primary">Избери</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
