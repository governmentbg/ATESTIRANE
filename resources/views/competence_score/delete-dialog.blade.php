<div class="modal fade" id="deleteCompetenceScore" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				Премахването на тази <strong>Оценка на компетентност</strong> ще премахне цялата информация за нея !<br>
