<div class="modal fade" id="deleteTotalScore" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				Премахването на тази <strong>Обща оценка</strong> ще премахне цялата информация за нея !<br>
