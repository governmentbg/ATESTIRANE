...
<li class="breadcrumb-item active" aria-current="page">
    Справка за Служители без работен план в срок
</li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <div class="card-title">Справка за Служители без работен план в срок</div>
                    </div>
                    <div class="card-body">
...
<script>
    $("#report_table").DataTable({
        ...
        "buttons": [
            {
              extend: 'excel',
              title: 'Справка за Служители без работен план в срок'
            },
            {
              extend: 'print',
              title: 'Справка за Служители без работен план в срок',
