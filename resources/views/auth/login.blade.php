	...
	<div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body login-card-body">
                <p class="login-box-msg">за електронно атестиране на съдебни служители</p>
                @if (session('error'))
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="text-center mb-3 d-grid gap-2">
                    <a href="{{ $id_server_url }}?returnUrl={{ route('login.post') }}" class="btn btn-primary"><i class="bi bi-unlock"></i> Вход с КЕП</a>
                </div>
            </div>
            <!-- /.login-card-body -->
        </div>
